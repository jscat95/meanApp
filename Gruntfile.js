...
module.exports = function(grunt) {
  ...
  /*  concat: {
      ...
      //     '<%= yeoman.client %>/{app,components}/**/!(*.spec|*.mock|*.module.*).js',
          //       '!{.tmp,<%= yeoman.client %>}/app/app.{js,ts}'
       //          ],
          // the location of the resulting JS file
     //     dest: '<%= yeoman.client %>/app/dist/<%= pkg.name %>.js'
   //     }
  //    },
  //    uglify: {
 //       dist: {
 //           files: {
//                 '<%= yeoman.client %>/app/dist/<%= pkg.name %>.min.js': ['<%= yeoman.client %>/app/dist/<%= pkg.name %>.js']
 //         }
 //       }
  //    }
  });
  ...
  grunt.registerTask('hello', function(target, option) {
